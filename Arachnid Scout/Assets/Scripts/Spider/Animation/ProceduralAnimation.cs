...
public class ProceduralAnimation : MonoBehaviour
{
    ...
    */
    ...
    IEnumerator TweenPosition(LegData legData, Vector3 endPosition, float duration)
    {
        ...
        //get navmesh agent attached to this game object and check if its still moving
        //if its still moving then set trigger audio

        // if(!gameObject.GetComponent<SpiderAI>().Agent.isStopped){
        //     AudioManager.Instance.PlaySoundAtPosition(AudioManager.Instance.SpiderFootstep, transform.position, 0.3f, 0.5f);
        // }
