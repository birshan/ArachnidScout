...
public class EggScript : MonoBehaviour
{
    ...
    private GameObject _fracturedEgg;
    private EggFracturedExplode _fractureEggScript;
    private void Awake() {
        ...
        _fracturedEgg = transform.GetChild(1).gameObject;
        _fractureEggScript = _fracturedEgg.GetComponent<EggFracturedExplode>();
    ...
    IEnumerator HatchEggCoroutine()
    {
        ...
        // _fracturedEgg.SetActive(true);
        _fractureEggScript.Explode();
